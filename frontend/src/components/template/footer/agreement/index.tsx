    ...
    <Layout bgColor='bg_blue'>
      ...
      <div className={style.main}>
        <section>
          ...
          <div>
            この利用規約（以下、「本規約」といいます。）は、TOKOTOKO=J（以下、「当事務局」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
          </div>
        </section>
        <section>
          <h1>第1条（適用）</h1>
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                ...
                <li>3.その他，当事務局が利用登録を相当でないと判断した場合</li>
              </ul>
            </li>
          </ul>
        </section>
        <section>
          <h1>第3条（ユーザーIDおよびパスワードの管理）</h1>
          <ul>
            <li>
        ...
        <section>
          ...
          <ul>
            ...
            <li>5.当事務局のサービスの運営を妨害するおそれのある行為</li>
            <li>6.不正アクセスをし，またはこれを試みる行為</li>
            <li>7.他のユーザーに関する個人情報等を収集または蓄積する行為</li>
            <li>8.不正な目的を持って本サービスを利用する行為</li>
            <li>
              9.本サービスの他のユーザーまたはその他の第三者に不利益，損害，不快感を与える行為
            </li>
            <li>10.他のユーザーに成りすます行為</li>
            <li>
              11.当事務局のサービスに関連して，反社会的勢力に対して直接または間接に利益を供与する行為
            </li>
            <li>12.その他，当事務局が不適切と判断する行為</li>
          </ul>
        </section>
        <section>
          <h1>第5条（本サービスの提供の停止等）</h1>
          <ul>
            <li>
              ...
              <ul>
                ...
                <li>4.その他，当事務局が本サービスの提供が困難と判断した場合</li>
              </ul>
            </li>
            <li>
        ...
        <section>
          <h1>第6条（利用制限および登録抹消）</h1>
          <ul>
            <li>
              1.当事務局は，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，ユーザーに対して，本サービスの全部もしくは一部の利用を制限し，またはユーザーとしての登録を抹消することができるものとします。
            </li>
            <li>2.本規約のいずれかの条項に違反した場合</li>
            <li>3.登録事項に虚偽の事実があることが判明した場合</li>
            <li>4.当事務局からの連絡に対し，一定期間返答がない場合</li>
            <li>5.本サービスについて，最終の利用から一定期間利用がない場合</li>
            <li>6.その他，当事務局が本サービスの利用を適当でないと判断した場合</li>
            <li>
              7.当事務局は，本条に基づき当事務局が行った行為によりユーザーに生じた損害について，一切の責任を負いません。
            </li>
          </ul>
        </section>
        ...
        <section>
          <h1>第12条（通知または連絡）</h1>
          <p>
            ユーザーと当事務局との間の通知または連絡は，当事務局の定める方法によって行うものとします。当事務局は,
