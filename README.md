# TOKOTOKO=J V2
**現在TOKOTOKO=Jのリプレスを行っています。詳細はフロントエンド・バックエンド各リポジトリに記載しています。**
<br />
<br />
【リプレイスに至った経緯】
...
**tokotoko=Jは2023年7月-９月にこれまでの独学の集大成として作成しました。その当時の自分としてかなり完成度が高く、使ってくれた友人やサッカーファンからのポジティブなコメントなどもあり、納得いく形にできたと感じています。**
  <br />
**しかしその後多くのチーム開発などを通して、エンジニアとしての幅が広がりました。**  <br />
**そこで今回はよりユーザー目線でのプロダクトを開発したいと思い、TOKOTOKO=J v2を作成することにしました。**
