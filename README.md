...
<br />
 ...
 （状態と処理を分ける。Imutabilityの保持。コンポーネント影響範囲の特定しやすくする。責務が明らかにする。）
<br />
クリーンなコードを意識することの最大のメリットは**保守性を高めること**ができる。
開発中やリリース後に多くのバグが発生することが予測できた。その中で**バグを迅速に発見し、他のコンポーネントに影響を与えないように修正することができる**と考えた。
## 今回の反省と今後の展開
+ 要件定義
